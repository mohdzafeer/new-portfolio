        ...
        <div className='grid xl:grid-cols-6 lg:grid-cols-3 md:grid-cols-3 grid-cols-2 gap-4 w-full '>
            {skillData.map((data) => {
                return (<motion.div
                    ...
                    // }}
                    className='bg-white flex flex-col items-center justify-center gap-4 border-2 border-gray-100 py-3 rounded-xl hover:bg-blue-100 hover:border-2 hover:border-blue-300 hover:shadow-xl hover:shadow-blue-200 duration-500  active:bg-blue-100'>
