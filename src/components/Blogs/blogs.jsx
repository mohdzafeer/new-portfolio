...
const Blogs = () => {
    return (
        <div className='flex gap-6 flex-col items-center lg:flex-row'>
            <div className='bg-white p-2 rounded-xl border-2 border-gray-100 lg:w-sm w-xs  hover:bg-blue-100 hover:border-2 hover:border-blue-300 hover:shadow-xl hover:shadow-blue-200 duration-500  active:bg-blue-100 flex flex-col items-center justify-around'>
