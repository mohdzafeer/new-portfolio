            ...
            <div className=''>
                <StyledWrapper className='grid xl:grid-cols-3 xl:gap-10 lg:grid-cols-2 lg:gap-5 gap-3 grid-cols-1 '>
                    {projectdata.map((data) => {
                        ...
                        // }}
                        className="bg-white w-full rounded-xl border-2 border-gray-100 py-3 m-0 flex flex-col items-center justify-around gap-6 px-3 hover:border-2 hover:bg-blue-100 hover:border-blue-300 hover:shadow-xl hover:shadow-blue-200 duration-500 cursor-pointer">
