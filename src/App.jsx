  ...
  return (
    ...
    <div>
      ...
      <div className='overflow-x-hidden scroll-smooth '>
        ...
        <div className=' min-w-screen min-h-screen xl:px-96 lg:px-72 px-10 md:px-20 lg:pt-10 pt-5 relative  '>
